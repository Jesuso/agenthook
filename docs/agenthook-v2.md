...
v2 makes agenthook *a tool you install*: `npm i -g @jesuso/agenthook`, scaffold a config per
...
`npm i -g @jesuso/agenthook` installs an `agenthook` CLI. The existing bash ops scripts
